...
/**
 * @file form-pelanggan.tsx
 * @description Halaman form untuk menambah data pelanggan baru ke database SQLite.
...
export default function FormPelanggan() {
  ...
  // Logic: Refs untuk perpindahan fokus input
